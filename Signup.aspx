<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="VisaApplication.Signup" %>
		...
		<div class="col-md-5 mx-auto">
		  <div id="first">
			<div class="myform form">
                ...
                <div class="col-md-12 text-center ">
                    <asp:button runat="server" ID="SignupBtn" OnClick="SignupBtn_Click" CssClass="btn btn-block mybtn btn-primary tx-tfm" Text="Signup"></asp:button>
                </div>
                <div class="col-md-12 ">
                    <div class="login-or">
                        <hr class="hr-or">
                ...
                <div class="form-group">
                    <p class="text-center">Already have a account? <a href="Login.aspx" id="signup">Login in here</a></p>
                </div>
			</div>
		</div>
        </div>
